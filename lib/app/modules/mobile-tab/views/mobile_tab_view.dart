...
class MobileTabView extends GetView<MobileTabController> {
  MobileTabView({Key? key}) : super(key: key);

  final List<Map<String, dynamic>> products = [
    {
      'imageUrl':
          '../../../../../assets/images/cms/categories/mobile-tab/mobile1.png',
      'title': 'Macbook Pro',
    ...
    {
      'imageUrl':
          '../../../../../assets/images/cms/categories/mobile-tab/mobile2.png',
      'title': 'iPhone 12',
      'specification': '(256GB/8GB & 512GB/12GB)',
      'price': 'RM 4500',
    ...
    {
      'imageUrl':
          '../../../../../assets/images/cms/categories/mobile-tab/mobile3.png',
